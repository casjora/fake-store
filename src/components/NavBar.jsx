    ...
    <div className="w-full shadow-md flex gap-5 px-5 items-center justify-between border-4">
      <div className="flex gap-5">
        <div className="flex">
          ...
          <Link className="text-lg font-semibold flex items-center justify-center" to={"/"}>
      ...
      <div className="flex gap-5">
        <input className="bg-slate-200 px-3 hidden md:flex justify-center items-center rounded-md" type="text" name="searchBar" id="searchBar" placeholder="🔎Search Products" />
